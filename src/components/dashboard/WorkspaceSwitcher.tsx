    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <div className="h-7 w-7 rounded-md bg-gradient-to-br from-cyan-400/30 to-blue-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0">
            <Building2 className="h-3.5 w-3.5 text-cyan-300" aria-hidden />
          </div>
          ...
          >
            {workspaces.map((ws) => (
              ...
              >
                ...
                {ws.slug === currentSlug && (
                  <Check className="h-4 w-4 text-cyan-400 flex-shrink-0" aria-hidden />
                )}
              </button>
            ))}
          </div>
